...
HD_PWD='C:/Users/Blaz/Desktop/KONCNA_VERZIJA/fa_fs/fa_fs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_network_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neural_network_control.tcl -notrace
