...
HD_PWD='C:/Users/Blaz/Desktop/KONCNA_VERZIJA/fa_fs/fa_fs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_network_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neural_network_control.tcl
