...
#create_clock -add -name sys_clk_pin -period 16.013 -waveform {0 4} [get_ports { clk }];
...
##Buttons
##set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { b[0] }]; #IO_L20N_T3_34 Sch=BTN0
##set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { b[1] }]; #IO_L24N_T3_34 Sch=BTN1
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { all_rez[0] }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { all_rez[1] }]; #IO_L23N_T3_35 Sch=LED1
